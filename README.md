...
A web-based project developed using HTML and CSS.

### 🧮 Calculator UI

A simple and attractive calculator user interface created using HTML.

### 🌾 Agri Pesticide Prediction

A group project related to agriculture and pesticide prediction.
